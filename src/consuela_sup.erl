...
-spec start_link() -> {ok, pid()} | {error, _Reason}.
start_link() ->
...
-spec mk_presence_childspec(consuela_presence_sup:opts() | undefined) -> [supervisor:child_spec()].
...
-spec mk_discovery_childspec(consuela_discovery_sup:opts() | undefined) -> [supervisor:child_spec()].
...
-spec mk_registry_childspec(consuela_registry_sup:opts() | undefined) -> [supervisor:child_spec()].
